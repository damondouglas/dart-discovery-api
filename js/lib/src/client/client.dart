...
abstract class Client extends ClientBase {
  core.String basePath = "/_ah/api/helloworld/v1/";
  core.String rootUrl = "https://dart-gdg-nyc-462.appspot.com/";

  //
  // Resources
  //

  GreetingsResource_ get greetings => new GreetingsResource_(this);
